...
def synthesize_feature_narratives(source_root: Path, output_root: Path, knowledge_graph_root: Path, application_source_root: Path) -> dict:
    ...
    validation = {
        ...
        **dict(aggregate_defects), "raw_workflow_mechanics": 0,
        ...
        "resolver_classifications_in_human_markdown": human_audit["resolver_terms"],
        "resolver_terms_in_human_markdown": human_audit["resolver_terms"],
        "source_file_paths_in_human_markdown": human_audit["source_paths"],
        "source_paths_in_human_markdown": human_audit["source_paths"],
        ...
        "legacy_implementation_language_in_human_markdown": human_audit["legacy_implementation_language"],
        "semantically_circular_stories": human_audit["semantically_circular_stories"],
        "vague_human_ac": human_audit["vague_human_ac"],
        "generic_clarification_questions": human_audit["generic_clarification_questions"],
        "backend_task_wrappers_as_primary_response": human_audit["backend_task_wrappers_as_primary_response"],
