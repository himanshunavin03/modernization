...
COMMANDS = (
    ...
    CommandDefinition("generate-stories", "PLAN", "Generate Jira-quality Stories for approved Features.", "generate_stories"),
    CommandDefinition("generate-acceptance-criteria", "PLAN", "Generate immutable acceptance criteria for approved Stories.", "generate_acceptance_criteria"),
