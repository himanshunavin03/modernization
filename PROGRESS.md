...
- Exact next action when resumed: Read `PROJECT_MEMORY.md`, `PROGRESS.md`, `DECISIONS.md`, prompt 019, and `docs/validation/healthclinic-ui-technology-discovery.md`, then await the scope decision.
