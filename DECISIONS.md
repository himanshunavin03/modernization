...
| `healthclinic-dashboard-scope-demo-v3` is the approved Dashboard Neo4j visual-demo graph. | It has 24 selected File nodes, 2,360 explicitly out-of-scope audited files, zero extraction warnings, scope-complete coverage, and an unchanged source-tree fingerprint. |
