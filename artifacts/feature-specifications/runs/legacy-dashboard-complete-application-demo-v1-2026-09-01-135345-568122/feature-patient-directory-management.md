...
The application provides tenant context for patient functionality. Users can access the existing patient directory.
...
The current implementation uses PatientsController, patients, patientsService.
...
so that the application can present the supported patient directory.
